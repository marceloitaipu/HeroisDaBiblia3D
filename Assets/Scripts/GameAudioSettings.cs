...
namespace HeroisDaBiblia3D
{
    ...
    /// Renomeado para evitar conflito com UnityEngine.AudioSettings.
    /// </summary>
    [CreateAssetMenu(fileName = "GameAudioSettings", menuName = "Heróis da Bíblia/Audio Settings", order = 3)]
